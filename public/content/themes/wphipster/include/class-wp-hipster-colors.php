...
class WP_Hipster_Colors
{
    private $palettes;
    private $colors;
    private $lightness_indices;


    /**
     * WP_Hipster_Colors constructor.
     */
    public function __construct()
    {
        ...
        $this->lightness_indices = ["lighten-5", "lighten-4", "lighten-3", "lighten-2", "lighten-1", "base", "darken-1", "darken-2", "darken-3", "darken-4", "accent-1", "accent-2", "accent-3", "accent-4"];
        $this->palettes = [
    ...
    public function color($name, $lightness = 'base')
    {
        $color = $this->palettes[array_search($name, $this->colors)];
        return $color[array_search($lightness, $this->lightness_indices)];
    }
}